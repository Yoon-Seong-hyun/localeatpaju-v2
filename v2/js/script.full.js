...
const translations = {
     ko: {
          ...
          value_title: "왜 '로컬잇파주'인가?",
          value_desc: "단순한 농산물을 파는 것이 아닙니다.<br>자연과 사람, 그리고 당신의 식탁을 잇는 이야기를 전합니다.",
          feat_1_title: "24시간 배송",
          feat_1_text: "오늘 아침 수확, 오늘 저녁 식탁.<br>파주 내 100% 당일 수확 및 배송을 원칙으로 합니다. 긴 유통 과정에서 잃어버리기 쉬운 맛과 영양을 그대로 지킵니다.",
          feat_1_link: "운영 정책 보기",
          feat_2_title: "투명한 실명제",
          feat_2_text: "누가, 어디서, 어떻게 길렀는지 숨기지 않습니다.<br>모든 상품에는 농부의 얼굴과 이름, 작물에 쏟은 정성이 담긴 '영농일지' QR코드가 함께합니다.",
          feat_3_title: "오감 만족 체험",
          feat_3_text: "먹는 즐거움을 넘어 기르는 기쁨까지.<br>주말 농장 분양부터 제철 수확 프로그램까지, 흙을 만지며 자연과 교감하는 소중한 추억을 선물합니다.",
          feat_3_link: "체험 예약하기",
          ...
          exp_title: "파주에서 즐기는<br>특별한 하루",
          exp_desc: "단순한 구매를 넘어 체험으로 완성하는 로컬 여행.<br>이번 주말, 사랑하는 사람들과 파주로 떠나보세요.",
          farmer_tag: "파주로 돌아온 청년들의 이야기",
          farmer_title: "\"나보다 못난이라도 괜찮아,<br>농약은 안먹고 자랐으니까..\"",
          farmer_desc: "파주 문산읍에서 40년째 사과 농사를 짓는 <b style='color: #333;'>김철수 농부</b>.<br>그는 올해 유난히 심했던 비바람을 견뎌낸 사과들이 기특하다고 말합니다. 모양은 조금 투박해도, 껍질째 베어 물면 입안 가득 퍼지는 깊은 풍미는 백화점 과일과 비교할 수 없습니다.",
          farmer_btn_interview: "인터뷰 전문 보기",
          farmer_btn_buy: "못난이 사과 구매하기",
          export_tag: "K-WELLNESS GLOBAL PROJECT",
          export_title: "파주의 맛, 세계로",
          export_desc: "장단콩을 활용한 <strong>두부 과자</strong>부터 인삼 젤리까지.<br>파주의 특산물을 가공하여 세계인의 입맛을 사로잡습니다.",
          ...
          ai_title: "스마트 로컬 라이프",
          ai_desc: "무엇을 먹을지, 누구에게 선물할지 고민되시나요?<br>AI가 당신의 취향과 상황에 맞는 제안을 해드립니다.",
          ai_tab_chef: "장바구니 셰프",
          ai_tab_gift: "선물 큐레이터",
     ...
     try {
          ...
          return [
               ...
               },
               {
                    ...
                    "badges": ["무농약인증"],
                    "description": "임진강의 맑은 물과 기름진 땅이 키워낸 명품 쌀. 밥알 하나하나가 살아있고 씹을수록 단맛이 납니다.",
                    "trans": {
               ...
               // --- B. Hidden Gems (숨은 보석) ---
               {
                    ...
                    "badges": ["숙취해소", "이너뷰티"],
                    "description": "사람의 손이 닿지 않는 감악산 깊은 곳의 야생 칡. 흙 속의 진주라 불리는 칡의 진한 생명력을 담았습니다.",
                    "trans": {
               ...
               },
               {
                    ...
                    "price": 60000,
                    "category": "CAMPING",
                    "image": "assets/images/korean_camping_bbq.png",
                    "badges": ["프라이빗", "수영장"],
               ...
               },
               {
                    ...
                    "price": 40000,
                    "category": "CAMPING",
                    "image": "assets/images/korean_camping_river.png",
                    "badges": ["계곡물놀이", "샤워장"],
               ...
               },
               {
                    ...
                    "price": 30000,
                    "category": "CAMPING",
                    "image": "assets/images/korean_park_camping.png",
                    "badges": ["넓은공간", "조용한"],
...
function renderApp() {
     ...
     const marketProducts = globalProducts.filter(p => !p.category.includes('FARM') && !p.category.includes('CAMPING') && !p.category.includes('TOUR') && !p.category.includes('EXPERIENCE') && !p.category.includes('GLAMPING') && !p.category.includes('AUTOCAMP'));
     const experienceProducts = globalProducts.filter(p => p.category.includes('FARM') || p.category.includes('CAMPING') || p.category.includes('TOUR') || p.category.includes('EXPERIENCE') || p.category.includes('GLAMPING') || p.category.includes('AUTOCAMP'));
